      ...
      <div className="fixed top-0 left-0 w-full text-xs text-white flex justify-between px-4 py-4">
        ...
        <div className="flex  gap-6">
          <div className="flex justify-center items-center gap-1">
            <img src="./assets/images/alert.png" alt="" className="w-6 " />
            Issue with ticket?
          </div>
          <div className=" underline">All tickets</div>
        </div>
      </div>
      <div className=" bg-white rounded-md    flex flex-col p-4 gap-1 w-full ">
        ...
        <>
          ...
          <div className="flex justify-between border-b py-2">
            ...
            <div className="">₹{getPriceLabel(ticketPrice)*ticketCount.toFixed(2)}</div>
          </div>
          <div className="flex justify-between py-1">
            ...
            <div className=" flex flex-col text-right">
              ...
              <div className="font-semibold">₹{ticketPrice*ticketCount}.0</div>
            </div>
          </div>
          <div className="flex justify-between py-1">
            <div className=" flex flex-col">
